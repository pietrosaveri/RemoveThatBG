...
- **main:** This is the original app, built with a Python backend and using [rembg](https://github.com/danielgatis/rembg). It supports multiple specialized local models and can run fully offline. Truly amazing, created by my own original mind. (this version is only avaible here on github in the releases section)
